...
function validateAndNormaliseUserInput(_, __, config) {
    ...
    return {
        basePath: new normalisedURLPath_1.default(
            (_a = config === null || config === void 0 ? void 0 : config.basePath) !== null && _a !== void 0
                ? _a
                : "/api"
        ),
        domain: new normalisedURLDomain_1.default(
            (_b = config === null || config === void 0 ? void 0 : config.domain) !== null && _b !== void 0
                ? _b
                : "http://localhost:3002"
        ),
        mode:
